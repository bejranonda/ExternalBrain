  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ fontSize: 22, fontWeight: 500, margin: 0, letterSpacing: "-0.01em" }}>{t("auth.resetTitle")}</h1>
        {sent ? (
          // ── Success state ──────────────────────────────────────────────
          <>
            <div
            ...
            >
              <strong style={{ color: "var(--ink, #ececf0)" }}>{t("auth.checkEmail")}</strong>
              <br />
            ...
            <div style={{ fontSize: 12, color: "var(--ink-4, #6b6d7a)", lineHeight: 1.5 }}>
              Did not receive it?{" "}
              <a href="/forgot-password" style={{ color: "var(--accent-text, #7aa2f7)", textDecoration: "none" }}>{t("auth.tryAgain")}</a>
              {" "}&mdash;{" "}
          ...
          // ── Form state ────────────────────────────────────────────────
          <>
            <div style={{ fontSize: 13, color: "var(--ink-3, #9a9cab)", marginBottom: 20 }}>{t("auth.resetIntro")}</div>
            ...
            >
              <label style={{ display: "block", marginBottom: 18 }}>
                <span style={labelSpan}>{t("auth.emailAddress")}</span>
                <input
                  type="email"
                  name="email"
                  autoComplete="email"
