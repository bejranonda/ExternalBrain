...
8. **Autoskill never edits without approval.** Unless user has opted-in to auto-apply HIGH, every `AutoskillProposal` sits in `pending` until a human acts.
