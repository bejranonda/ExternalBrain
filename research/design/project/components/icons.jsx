...
const Icon = ({ name, size = 14 }) => {
  const paths = {
    ...
    dashboard: <><rect x="2" y="2" width="5" height="6" rx="1" /><rect x="2" y="10" width="5" height="4" rx="1" /><rect x="9" y="2" width="5" height="4" rx="1" /><rect x="9" y="8" width="5" height="6" rx="1" /></>,
    oracle: <><path d="M2 4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H6l-3 2v-2H4a2 2 0 0 1-2-2z" /><circle cx="5.5" cy="7" r="0.6" fill="currentColor" /><circle cx="8" cy="7" r="0.6" fill="currentColor" /><circle cx="10.5" cy="7" r="0.6" fill="currentColor" /></>,
    skills: <><path d="M2 4h12M2 8h12M2 12h8" /></>,
    graph: <><circle cx="8" cy="3" r="1.6" /><circle cx="3" cy="11" r="1.6" /><circle cx="13" cy="11" r="1.6" /><circle cx="8" cy="12.5" r="1.3" /><path d="M7 4.3 3.8 9.7M9 4.3l3.2 5.4M4.5 11.5h2M9.3 11.7l2.4-.4" /></>,
    autoskill: <><path d="M8 2v3M8 11v3M2 8h3M11 8h3M4 4l2 2M10 10l2 2M4 12l2-2M10 6l2-2" /></>,
    sessions: <><rect x="2" y="3" width="12" height="10" rx="1" /><path d="M2 6h12M5 3v10" /></>,
    ...
    file: <><path d="M3 2h6l3 3v9H3z" /><path d="M9 2v3h3" /></>,
    link: <path d="M6.5 9.5 9.5 6.5M7 4l1-1a2.5 2.5 0 0 1 3.5 3.5l-1 1M9 12l-1 1a2.5 2.5 0 0 1-3.5-3.5l1-1" />,
    cite: <><rect x="2" y="2" width="12" height="12" rx="1.5" /><path d="M5 6h6M5 9h4" /></>,
    ...
    branch: <><circle cx="4" cy="3" r="1.5" /><circle cx="4" cy="13" r="1.5" /><circle cx="12" cy="8" r="1.5" /><path d="M4 4.5v7M5.5 13c4 0 5-2 5-3.5" /></>,
    bookmark: <path d="M4 2h8v12l-4-3-4 3z" />,
    copy: <><rect x="5" y="2" width="9" height="9" rx="1" /><path d="M5 5H3a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1v-2" /></>,
    claude: <path d="M4 4l1.8 5-1.8 5m3-10v10m1-10 1.8 5-1.8 5m3-10 1.8 5-1.8 5" />,
    cursor: <path d="m3 2 10 5-4 1-1 4z" />,
    windsurf: <><path d="M2 6c2 0 2 2 4 2s2-2 4-2 2 2 4 2" /><path d="M2 11c2 0 2-2 4-2s2 2 4 2 2-2 4-2" /></>,
    mcp: <><circle cx="8" cy="8" r="6" /><path d="M4 8c0-2 1-4 4-4s4 2 4 4M8 12V4" /></>,
  };
  return (
